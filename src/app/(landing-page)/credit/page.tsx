...
export default function CreditPage() {
    ...
    return (
        <main ref={containerRef} className="min-h-screen pt-32 pb-16 px-4 sm:px-8 md:px-12 lg:px-16 bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center">
                ...
                {/* Header */}
                <div className="credit-header text-center mb-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
                    {developers.map((dev, index) => (
                        <div
                            key={index}
                            className="credit-card bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col items-center text-center hover:shadow-[0_8px_30px_rgb(62,64,149,0.1)] transition-shadow duration-300 group"
                        >
                ...
                {/* Special Thanks */}
                <div className="credit-footer mt-24 p-8 bg-gradient-to-r from-primary to-secondary rounded-3xl text-white text-center w-full max-w-4xl shadow-xl relative overflow-hidden">
