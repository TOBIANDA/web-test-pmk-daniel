    ...
    return (
        <section className={cn(
            ...
            <h1 className={cn(
                ...
                "text-2xl sm:text-3xl md:text-4xl xl:text-[64px]"
            )}>
                Kata Sambutan
            </h1>
            <h2 className={cn(
                "font-plusJakarta font-normal mt-2",
            ...
            <div className={cn(
                ...
                "relative mt-8 sm:mt-12 lg:mt-14",
                "xl:h-110 2xl:h-130 overflow-hidden"
            )}>
                {dataKetua.map((data) => (
                    <div key={data.nama} className={cn(
                        ...
                        <h3 className={cn(
                            ...
                            "font-plusJakarta font-bold text-white",
                            "text-lg sm:text-xl lg:text-2xl xl:text-[40px]"
                        )}>
                            {data.nama}
                        </h3>
                        <p className={cn(
                            ...
                            "left-4 sm:left-6 lg:left-10",
                            "font-plusJakarta font-normal text-white",
